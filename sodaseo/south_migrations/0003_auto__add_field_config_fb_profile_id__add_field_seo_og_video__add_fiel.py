...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.fb_profile_id'
        db.add_column(u'sodaseo_config', 'fb_profile_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Seo.og_video'
        db.add_column(u'sodaseo_seo', 'og_video',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Seo.og_audio'
        db.add_column(u'sodaseo_seo', 'og_audio',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Seo.og_see_also'
        db.add_column(u'sodaseo_seo', 'og_see_also',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Seo.article_author'
        db.add_column(u'sodaseo_seo', 'article_author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Seo.article_publisher'
        db.add_column(u'sodaseo_seo', 'article_publisher',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Config.fb_profile_id'
        db.delete_column(u'sodaseo_config', 'fb_profile_id')

        # Deleting field 'Seo.og_video'
        db.delete_column(u'sodaseo_seo', 'og_video')

        # Deleting field 'Seo.og_audio'
        db.delete_column(u'sodaseo_seo', 'og_audio')

        # Deleting field 'Seo.og_see_also'
        db.delete_column(u'sodaseo_seo', 'og_see_also')

        # Deleting field 'Seo.article_author'
        db.delete_column(u'sodaseo_seo', 'article_author')

        # Deleting field 'Seo.article_publisher'
        db.delete_column(u'sodaseo_seo', 'article_publisher')
