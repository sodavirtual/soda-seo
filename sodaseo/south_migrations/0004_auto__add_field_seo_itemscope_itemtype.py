...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seo.itemscope_itemtype'
        db.add_column(u'sodaseo_seo', 'itemscope_itemtype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seo.itemscope_itemtype'
        db.delete_column(u'sodaseo_seo', 'itemscope_itemtype')
