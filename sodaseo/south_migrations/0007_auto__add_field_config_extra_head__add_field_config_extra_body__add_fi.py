...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.extra_head'
        db.add_column(u'sodaseo_config', 'extra_head',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Config.extra_body'
        db.add_column(u'sodaseo_config', 'extra_body',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Seo.image'
        db.add_column(u'sodaseo_seo', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'seo_image', null=True, on_delete=models.SET_NULL, to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Config.extra_head'
        db.delete_column(u'sodaseo_config', 'extra_head')

        # Deleting field 'Config.extra_body'
        db.delete_column(u'sodaseo_config', 'extra_body')

        # Deleting field 'Seo.image'
        db.delete_column(u'sodaseo_seo', 'image_id')
    ...
    models = {
        ...
        u'sodaseo.config': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'extra_body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'extra_head': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'sodaseo.seo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'seo_image'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['filer.Image']"}),
